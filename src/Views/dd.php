<script>
    Sfdump = window.Sfdump || (function (doc) {
        ...
        var rxEsc = /([.*+?^${}()|\[\]\/\\])/g, idRx = /\bsf-dump-\d+-ref[012]\w+\b/,
...
<pre class=sf-dump id=sf-dump-93022049 data-indent-pad="  ">
<span class=sf-dump-note>array:1</span>[<samp data-depth=1 class=sf-dump-expanded><span style="color: #A0A0A0;">// routes\web.php:23</span>
    <span class=sf-dump-index>0</span> => <span class=sf-dump-num>123</span>
</samp>]
</pre>
<script>
    Sfdump("sf-dump-93022049")
</script>